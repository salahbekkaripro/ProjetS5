...
SECRET_KEY = 'django-insecure-553kynu%hk6v--2jl%%bz2_1h_6=!*n+r1i(mw31i=11=!v7g7'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'messaging.context_processors.messaging_counts',
            ],
        },
    },
]
...
SUBSCRIPTION_PLAN_ORDER = ["free", "fitplus", "pro", "ultra"]
